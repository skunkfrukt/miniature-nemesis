...
class TestCollider(unittest.TestCase):
    def setUp(self):
        ...
        self.collider = Collider(0,0,10,10)
        
        # Concentric colliders.
        self.small_collider = Collider(4,4,2,2)
        self.large_hadron_collider = Collider(-5,-5,20,20)
        
        # Colliders to the north and to the south of main.
        self.north_discrete = Collider(-5,13,20,2)
        self.north_overlapping = Collider(-5,5,20,10)
        self.south_discrete = Collider(-5,-5,20,2)
        self.south_overlapping = Collider(-5,-5,20,10)
        
        # Colliders to the east and to the west of main.
        self.east_discrete = Collider(13,-5,2,20)
        self.east_overlapping = Collider(5,-5,10,20)
        self.west_discrete = Collider(-5,-5,2,20)
        self.west_overlapping = Collider(-5,-5,10,20)
        
        # Colliders in the corners of main.
        self.southwest_discrete = Collider(-5,-5,2,2)
        self.southwest_overlapping = Collider(-5,-5,10,10)
        self.southeast_discrete = Collider(13,13,2,2)
        self.southeast_overlapping = Collider(5,5,10,10)
        self.northwest_discrete = Collider(-5,13,2,2)
        self.northwest_overlapping = Collider(-5,5,10,10)
